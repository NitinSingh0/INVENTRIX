...
<body>
  ...
  <div class="container">
    <h1 class="heading">Click Click Event Registration</h1>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO stumble (email, leader,player2,player3,player4,roll, course,department, contact)
            VALUES ('$email', '$fname','$mname','$lname','$lname1','$rollno', '$course','$department',  '$contact_no')";
    $q=$conn->query($sql);
