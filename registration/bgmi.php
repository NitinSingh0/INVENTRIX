...
<head>
  ...
  <title>BGMI Event Registration</title>
...
<body>
  ...
  <div class="container">
    <h1 class="heading">BGMI Event Registration</h1>
    <form action="bgmi.php" method="post">
        <div class="field">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO details (email, fname,mname,lname,rollno, course,department, game, contact_no)
            VALUES ('$email', '$fname','$mname','$lname','$rollno', '$course','$department', 'BGMI', '$contact_no')";
    $q=$conn->query($sql);
