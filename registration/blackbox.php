...
<head>
  ...
  <title>Black Box Event Registration</title>
...
<body>
  ...
  <div class="container">
    <h1 class="heading">Black Box Event Registration</h1>
    <form action="blackbox.php" method="post">
        <div class="field">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO details (email, fname,mname,lname,rollno, course,department, game, contact_no)
            VALUES ('$email', '$fname','$mname','$lname','$rollno', '$course','$department', 'Black Box', '$contact_no')";
    $q=$conn->query($sql);
