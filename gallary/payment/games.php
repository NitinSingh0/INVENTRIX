  ...
  <div class="row justify-content-center">
    <div class="col-lg-8">
      <div class="login">
        ...
        <form class="row  mg-auto" method="POST" action="games.php">
          <div class="form-group">
            <input type="text" class="form-control " id="user" name="email" placeholder="Email">
          </div>
          <div class="form-group">
            <select class="form-control " id="user" name="game" >
       ...
       <a href="tresure.php" >TRESURE HUNT</a><br>
       <a href="click.php" >CLICK CLICK</a>
...
if (isset($_POST['status'])) {
 $id=$_POST['id'];
  $status=$_POST['status'];
      $s = "UPDATE details set status='$status' WHERE id='$id'";
  $qu = $conn->query($s);
 ...
 // echo $admin;
  ...
  $sql="SELECT * FROM details where email='$email' and game='$game'";
  $q = $conn->query($sql);
...
<hr>
      ...
      <div class="mainsize">
        <form method="POST" action="games.php" name="form2">
          <fieldset disabled>
