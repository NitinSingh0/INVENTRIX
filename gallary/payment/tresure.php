...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-lg-8">
      <div class="login">
        <h1>Trasure hunt Payment Status</h1>
        <form class="row  mg-auto" method="POST" action="tresure.php">
...
if (isset($_POST['status'])) {
 $id=$_POST['id'];
  $status=$_POST['status'];
      $s = "UPDATE tresurehunt set status='$status' WHERE id='$id'";
  $qu = $conn->query($s);
 ...
 // echo $admin;
  ...
  $sql="SELECT * FROM tresurehunt where email='$email'";
  $q = $conn->query($sql);
    ...
    if ($count) {
      ...
      ?>
      <form action="tresure.php" method="post">
<hr>
      ...
      <div class="mainsize">
        <form method="POST" action="tresure.php" name="form2">
          <fieldset disabled>
