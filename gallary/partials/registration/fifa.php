...
<head>
  ...
  <title>Click Click Event Registration</title>
...
<body>
  ...
  <div class="container">
    <h1 class="heading">FIFA'24 Event Registration</h1>
    <form action="fifa.php" method="post">
        <div class="field">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO details (email, fname,mname,lname,rollno, course,department, game, contact_no)
            VALUES ('$email', '$fname','$mname','$lname','$rollno', '$course','$department', 'FIFA24', '$contact_no')";
    $q=$conn->query($sql);
    // $count=mysqli_num_rows($q);
    if($q){
    $event="FIFA24";
    echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style=" width:100%; position: fixed; top: 0; left: 0; background-color:black; color:blue; ">
